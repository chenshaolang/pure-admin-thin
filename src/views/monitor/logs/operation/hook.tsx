...
import { clearOperationLogs, deleteOperationLogs, getOperationLogsList } from "@/api/system";
...
export function useRole(tableRef: Ref) {
  ...
  function onbatchDel() {
    ...
    deleteOperationLogs({ ids: getKeyList(curSelected, "id") }).then(() => {
  ...
  async function onSearch(page?: number, limit?: number) {
    ...
    const { data } = await getOperationLogsList(params);
